...
def changeArabNumToChinese(oriStr, simple=False):
    if simple:
        output_list = []
        for ch in oriStr:
            new_ch = num_dict.get(ch, ch)
...
def convert(str, simple=False):
    return changeArabNumToChinese(str, simple)
